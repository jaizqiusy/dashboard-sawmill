  ...
  return (
    <div className="p-5 space-y-6">
      <div className="bg-[#1e293b]/60 backdrop-blur-md rounded-2xl p-5 border border-white/5 shadow-lg">
        ...
        <p className="text-[11px] text-slate-400 mt-1 uppercase tracking-widest font-medium">Trend & Performance Analysis</p>
      </div>
      ...
      <div className="space-y-6">
        {timeframes.map((type) => {
          ...
          return (
            <div key={type} className="bg-[#1e293b]/40 backdrop-blur-sm rounded-2xl p-5 border border-white/5 shadow-lg">
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                <div className="bg-[#0f172a]/50 rounded-xl p-3 border border-white/5">
                  <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest mb-1">Avg Efficiency</p>
                  <p className="text-lg font-bold text-emerald-400">
                    {(timeframeData.reduce((acc, curr) => acc + curr.yield, 0) / timeframeData.length * 100).toFixed(1)}%
                  </p>
                </div>
                <div className="bg-[#0f172a]/50 rounded-xl p-3 border border-white/5 text-right">
                  <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest mb-1">Total Output</p>
